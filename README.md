...
│   ├── mock_prospects.png <- captura: prospectos de LinkedIn por aprobar
│   ├── mock_phases.png <- captura: fases del Modo Autonomo
...
Inicio · Que hace · Modo Autonomo (fases, comparativa, protecciones, cifras) · La app en accion · Como funciona · Alcances · Planes (sin precios, contacto hola@joel.cafe) · Descarga.
